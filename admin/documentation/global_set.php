  ...
  <tr>
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="3">
      <tr>
        ...
        Within this section you can configure global variables used within your site. The list can be modified at anytime with the use of a simple SQL query.</td>
      </tr>
    </table>
    <p align="center">&nbsp;</p>
    </td>
